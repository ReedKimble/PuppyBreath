...
Public Class CollisionInfo
    ...
    Public ReadOnly Property Source As Sprite
    ...
    Public ReadOnly Property Other As Sprite
    ...
    Protected Friend Sub New(sourceSprite As Sprite, otherSprite As Sprite, hit As PointF)
        Source = sourceSprite
        Other = otherSprite
        CollisionPoint = hit
    End Sub
